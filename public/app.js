...
$("#scan-offers").addEventListener("click", async () => {
  ...
  try {
    ...
    renderPayeeOffers(verified); notice(`${verified.length} safe PAPER offer${verified.length === 1 ? "" : "s"} found with at least 5h to accept and 2h post-accept work time`);
